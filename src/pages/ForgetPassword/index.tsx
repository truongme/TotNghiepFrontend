...
const ForgetPassword = () => {
  ...
  const { handleSubmit, control, formState: { errors } } = useForm<newPasswordProps>();
  ...
  return (
    <div className='container'>
          ...
          <div className='m-5 container'>
            ...
            {!token ? (
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div>
                        <label className='form-login-label'>Confirm New Password</label>
                        <Controller
                    ...
                    {resetPasswordFail && (
                        <div className="error-login-fail">Incorrect account or confirmPassword!</div>
                    )}
      ...
      {isOpenModal &&
        <ModalMain title='Notification' content='Password reset confirmation email has been sent to your email' btn2='Ok' onSave={handleCloseModal}/>
      }

      {isReseted &&
        <ModalMain title='Notification' content='Password reset successful, please login' btn2='Ok' onSave={handleCloseModalReset}/>
      }
    </div>
  );
};
