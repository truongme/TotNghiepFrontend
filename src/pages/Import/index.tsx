...
const Import = () => {
    ...
    const contentBody = () => {
        ...
        return (
            <div style={{width:'100%'}}>
                <div>
                    Ngày nhập hàng: {formattedDate}
                </div>
                <div className='input-form-import'>
                    <div>Tên nhà cung cấp</div>
                    <input className="form-control" id="exampleFormControlInput1" placeholder="Nhập tên nhà cung cấp"/>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className='container'>
            <div className='import-header'>
                ...
                <div>
                    <button className="btn-product" onClick={() => setIsOpenModal(true)}>Tạo phiếu</button>
                </div>
            </div>
